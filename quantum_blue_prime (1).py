...
def alpha_beta(board, depth, alpha, beta, maximizing_player):
    ...
    if maximizing_player:
        ...
        for move in list(board.legal_moves):
            new_board = board.copy()
            new_board.push(move)
            score = alpha_beta(new_board, depth - 1, alpha, beta, False) + Qfish_Evaluation(new_board) + VQC_Evaluation(new_board)
        ...
        for move in list(board.legal_moves):
            new_board = board.copy()
            new_board.push(move)
            score = alpha_beta(new_board, depth - 1, alpha, beta, True) + Qfish_Evaluation(new_board) + VQC_Evaluation(new_board)
...
with open(r"/content/vqc_model (1).dill", "rb") as f:
